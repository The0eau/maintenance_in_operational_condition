...
# 5. Visualisation de l'apport de la redondance (k-parmi-n)
t_seq_s <- seq(0, 2000, length.out = 100)

# Fiabilité individuelle
R_indiv_seq <- exp(-(t_seq_s / eta_s)^beta_s)

# Fiabilité système (3-parmi-4)
R_sys_seq <- choose(4, 3) * (R_indiv_seq^3) * (1 - R_indiv_seq) + (R_indiv_seq^4)

# Graphique
plot(t_seq_s, R_indiv_seq, type = "l", col = "red", lty = 2, lwd = 2,
     main = "Fiabilité des Capteurs : Individuelle vs Système (3/4)",
...
# Marquage du point à 500h
abline(v = 500, col = "gray", lty = 3)
points(500, R_sys, col = "darkgreen", pch = 19, cex = 1.2)

legend("bottomleft", 
       legend = c("Un seul capteur", "Système 3-parmi-4", "Cible 500h"),
       col = c("red", "blue", "darkgreen"), 
       lty = c(2, 1, NA), pch = c(NA, NA, 19), lwd = 2)
