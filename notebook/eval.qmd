...
nb_interv_lub_an <- 4  # Scénario : Lubrification chaque trimestre
...
L'analyse de la maintenance opportuniste démontre qu'une simple optimisation logistique génère des bénéfices tangibles sans nécessiter d'investissement matériel. En identifiant la mèche de perçage comme le composant « appelant » avec ses 53 remplacements annuels, nous avons pu synchroniser les 4 interventions de lubrification systématique pour créer des fenêtres de maintenance groupée. Cette stratégie permet de transformer des arrêts isolés en interventions coordonnées, dégageant un gain de productivité de 28 minutes par occurrence. À l'échelle de l'année, cette réduction du temps mort se traduit par une économie directe de 2 820 €, prouvant que la performance de l'atelier ne dépend pas uniquement de la fiabilité intrinsèque des machines, mais également de la pertinence de la planification humaine. Ces résultats soulignent l'importance de passer d'une maintenance subie à une maintenance pilotée par les opportunités du calendrier de production.
